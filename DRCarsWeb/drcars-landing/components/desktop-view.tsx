...
export function DesktopView() {
  ...
  const standardVehicles = vehicles.filter((vehicle) => vehicle.category === "standard")

  // Seleccionar vehículos destacados (3 de lujo)
  const featuredLuxuryVehicles = luxuryVehicles.slice(0, 3)

  // Seleccionar vehículos recientes (4 de cada categoría)
  const recentLuxuryVehicles = luxuryVehicles.slice(3, 7)
  const recentStandardVehicles = standardVehicles.slice(0, 4)
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2 pr-4 md:pr-8">
            <motion.div
          ...
          <nav className="flex items-center space-x-8">
            ...
            >
              <AnimatedLink href="/catalogo" className="text-gray-700 hover:text-primary transition-colors">
                Catálogo
              </AnimatedLink>
            </motion.div>
            <motion.div
            ...
            >
              <AnimatedLink href="/servicios" className="text-gray-700 hover:text-primary transition-colors">
                Servicios
              </AnimatedLink>
            </motion.div>
            <motion.div
            ...
            >
              <AnimatedLink href="/nosotros" className="text-gray-700 hover:text-primary transition-colors">
                Nosotros
              </AnimatedLink>
            </motion.div>
            <motion.div
            ...
            >
              <AnimatedLink href="/contacto" className="text-gray-700 hover:text-primary transition-colors">
                Contacto
              </AnimatedLink>
            </motion.div>
          </nav>
          ...
          <div className="flex items-center space-x-4 ml-auto">
            ...
            {/* UserDropdown siempre a la derecha */}
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.5, delay: 0.7 }}
      ...
      <section className="relative h-screen">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center items-center text-center px-6">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Vehículos de Importación</h1>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <p className="text-xl text-white/90 max-w-2xl mb-8">
              Descubre nuestra exclusiva selección de automóviles premium importados, donde la elegancia se encuentra
              con el rendimiento.
            </p>
          </motion.div>
          <motion.div
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-12">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Vehículos de Lujo</h2>
              <p className="text-gray-600 mt-2">Nuestra selección de automóviles premium</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {featuredLuxuryVehicles.map((car, index) => (
              <motion.div
                key={car.id}
                initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">Precios Competitivos</h3>
              <p className="text-gray-600">
            ...
            >
              ...
              <p className="text-gray-600">
                Nuestro equipo de asesores te guiará durante todo el proceso, desde la selección hasta la entrega de tu
                vehículo.
              </p>
            </motion.div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6 md:px-12 bg-primary text-white relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6">¿Buscas un vehículo específico?</h2>
              <p className="text-white/90 text-lg mb-8">
                Si no encuentras el vehículo que buscas en nuestro catálogo, podemos localizarlo para ti. Cuéntanos qué
                modelo estás buscando y nuestro equipo se pondrá manos a la obra.
              </p>
              <motion.div variants={buttonVariants} initial="initial" whileHover="hover" whileTap="tap">
                <RequestSearchDialog
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/servicios/importacion" className="text-gray-400 hover:text-white transition-colors">
                    Importación de Vehículos
                  </Link>
                </li>
                <li>
                  <Link href="/servicios/financiacion" className="text-gray-400 hover:text-white transition-colors">
                    Financiación
                  </Link>
                </li>
                <li>
                  <Link href="/servicios/mantenimiento" className="text-gray-400 hover:text-white transition-colors">
                    Mantenimiento
                  </Link>
                </li>
                <li>
                  <Link href="/servicios/seguros" className="text-gray-400 hover:text-white transition-colors">
                    Seguros
                  </Link>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm">© 2023 DRCars. Todos los derechos reservados.</p>
