...
CREATE TABLE `clientes` (
  ...
  KEY `claveForaneaUsuarios_idx` (`email`),
  CONSTRAINT `fk_cliente_usuario` FOREIGN KEY (`email`) REFERENCES `usuarios` (`usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `reservas` (
  ...
  KEY `fk_reserva_cliente` (`dni_cliente`),
  KEY `fk_reserva_vehiculo` (`id_vehiculo`),
  CONSTRAINT `fk_reserva_cliente` FOREIGN KEY (`dni_cliente`) REFERENCES `clientes` (`dni_cliente`) ON UPDATE CASCADE,
  CONSTRAINT `fk_reserva_vehiculo` FOREIGN KEY (`id_vehiculo`) REFERENCES `vehiculos` (`id_vehiculo`) ON UPDATE CASCADE
...
INSERT INTO `usuarios` VALUES ('a','a','ADMIN','2025-06-01 18:33:44','2025-05-31 10:46:44'),('blancomiguel.bj@gmail.com','maikol','ADMIN','2025-06-01 21:22:50','2025-05-07 20:56:12'),('elpepe','asasasd','USER','2025-05-30 00:20:58','2025-05-29 22:20:34'),('richi@gmail.com','richi','USER','2025-06-01 21:30:43','2025-06-01 20:49:34'),('superadmin@gmail.com','admin123','ADMIN','2025-05-29 22:19:22','2023-05-21 18:26:00');
...
CREATE TABLE `ventas` (
  ...
  `financiacion` enum('NO','3','6','9','12') DEFAULT NULL,
  `seguro` enum('1','2') DEFAULT NULL,
  PRIMARY KEY (`id_venta`),
  KEY `fk_venta_cliente` (`dni_cliente`),
  KEY `fk_venta_vehiculo` (`id_vehiculo`),
  KEY `fk_venta_trabajador` (`id_trabajador`),
  CONSTRAINT `fk_venta_cliente` FOREIGN KEY (`dni_cliente`) REFERENCES `clientes` (`dni_cliente`) ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_venta_vehiculo` FOREIGN KEY (`id_vehiculo`) REFERENCES `vehiculos` (`id_vehiculo`) ON UPDATE CASCADE
...
-- Dump completed on 2025-06-01 22:54:31
